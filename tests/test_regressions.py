...
class UiRegressionTests(unittest.TestCase):
    ...
    def test_web_ui_has_metrics_panel_and_job_actions(self):
        ...
        self.assertIn("const videoExtensions = new Set(['.mp4', '.mov', '.mkv', '.avi', '.mpeg', '.mpg', '.wmv'])", html)
        ...
        self.assertIn("resolvedMediaType === 'audio'", html)
    ...
    def test_web_ui_can_record_screen_audio_with_toggleable_microphone(self):
        ...
        self.assertIn("if (mode === 'video') return '錄影';", html)
        ...
        self.assertIn("setRecordingResult(`❌ ${recordingModeLabel()}失敗`, 'error')", html)
        self.assertIn("${recordingModeLabel()}失敗：沒有取得任何錄製資料", html)
        self.assertIn("setRecordingResult(`❌ ${recordingModeLabel()}檔案過大`, 'error')", html)
        self.assertIn("${recordingModeLabel()}檔案超過上限", html)
        self.assertIn("setRecordingResult(`✅ ${recordingModeLabel()}完成！正在送出 AI 分析，請稍候...`)", html)
        self.assertIn("${recordingModeLabel()}完成", html)
        self.assertIn("setRecordingResult(`❌ ${recordingModeLabel()}上傳失敗`, 'error')", html)
