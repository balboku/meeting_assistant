...
class UiRegressionTests(unittest.TestCase):
    ...
    def test_web_ui_has_metrics_panel_and_job_actions(self):
        ...
        self.assertIn("尚有未載入：${parts.join('、')}（目前上限 ${SOURCE_STORAGE_FETCH_LIMIT}）", html)
        ...
        self.assertIn("/source-media/inventory?limit=${SOURCE_STORAGE_FETCH_LIMIT}", html)
        self.assertIn("/source-media/archive?limit=${SOURCE_STORAGE_FETCH_LIMIT}", html)
