...
class UiRegressionTests(unittest.TestCase):
    ...
    def test_web_ui_has_metrics_panel_and_job_actions(self):
        ...
        self.assertIn("const previousSeconds = mediaPlayerCurrentSeconds(previousPlayer);", html)
        self.assertIn("restoreMediaPlayerSeconds(preview.querySelector('video.source-storage-media-player, audio'), previousSeconds);", html)
...
class FreeOptimizationRegressionTests(unittest.TestCase):
    ...
    def test_web_ui_shows_quality_report_and_segment_rerun_controls(self):
        ...
        self.assertIn("const previousSeconds = mediaPlayerCurrentSeconds(document.getElementById('source-media-player'));", html)
        self.assertIn("restoreMediaPlayerSeconds(document.getElementById('source-media-player'), previousSeconds);", html)
